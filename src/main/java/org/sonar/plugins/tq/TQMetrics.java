...
public final class TQMetrics implements Metrics {
	...
	public static final Metric TQ_TOTAL_QUALITY = new Metric(TQ_TOTAL_QUALITY_KEY, "Total Quality",
		"The total quality of a project", Metric.ValueType.PERCENT, Metric.DIRECTION_BETTER, true,
		CoreMetrics.DOMAIN_GENERAL);

	public static final String TQ_DRY_KEY = "tq-dry";
	public static final Metric TQ_DRY = new Metric(TQ_DRY_KEY, "DRYness", "DRY = 100 - "
		+ CoreMetrics.DUPLICATED_LINES_DENSITY_KEY, Metric.ValueType.PERCENT, Metric.DIRECTION_BETTER, true,
	...
	public static final Metric TQ_CODE = new Metric(TQ_CODE_KEY, "Code Quality", "CODE quality from "
		+ CoreMetrics.PUBLIC_DOCUMENTED_API_DENSITY_KEY + ", " + CoreMetrics.VIOLATIONS_DENSITY_KEY + " and "
		+ TQ_DRY_KEY, Metric.ValueType.PERCENT, Metric.DIRECTION_BETTER, true, CoreMetrics.DOMAIN_RULES);

	public static final String TQ_TS_KEY = "tq-ts";
	public static final Metric TQ_TS = new Metric(TQ_TS_KEY, "Testing Quality", "TS quality from "
		+ CoreMetrics.BRANCH_COVERAGE_KEY + ", " + CoreMetrics.LINE_COVERAGE_KEY + " and " + CoreMetrics.COVERAGE_KEY,
		Metric.ValueType.PERCENT, Metric.DIRECTION_BETTER, true, CoreMetrics.DOMAIN_TESTS);
	...
	public static final Metric TQ_DESIGN_NOM = new Metric(TQ_DESIGN_NOM_KEY, "Design Classes and Methods Complexity",
		"NOM from classes with " + CoreMetrics.FUNCTION_COMPLEXITY_KEY + " gt value (2.5 default) and "
	...
	public static final Metric TQ_DESIGN_RFC = new Metric(TQ_DESIGN_RFC_KEY, "Design Response for Class",
		"RFC from classes with " + CoreMetrics.RFC_KEY + " gt vale (50 default)", Metric.ValueType.PERCENT,
		Metric.DIRECTION_BETTER, true, CoreMetrics.DOMAIN_DESIGN);

	public static final String TQ_DESIGN_CBO_KEY = "tq-design-cbo";
	public static final Metric TQ_DESIGN_CBO = new Metric(TQ_DESIGN_CBO_KEY, "Design Coupling Between Objects",
		"CBO from classes with " + CoreMetrics.EFFERENT_COUPLINGS_KEY + " gt value (5 default)",
		Metric.ValueType.PERCENT, Metric.DIRECTION_BETTER, true, CoreMetrics.DOMAIN_DESIGN);

	public static final String TQ_DESIGN_DIT_KEY = "tq-design-dit";
	public static final Metric TQ_DESIGN_DIT = new Metric(TQ_DESIGN_DIT_KEY, "Design Depth of Inheritance Tree",
		"DIT from classes with " + CoreMetrics.DEPTH_IN_TREE_KEY + " gt value (5 default)", Metric.ValueType.PERCENT,
		Metric.DIRECTION_BETTER, true, CoreMetrics.DOMAIN_DESIGN);
	...
	public static final Metric TQ_ARCHITECTURE_COH = new Metric(TQ_ARCHITECTURE_COH_KEY, "Architecture Cohesion",
		"COH from inverse of files or packages with cycles", Metric.ValueType.PERCENT, Metric.DIRECTION_BETTER, true,
		DOMAIN_ARCHITECTURE);
	...
	public static final Metric TQ_ARCHITECTURE = new Metric(TQ_ARCHITECTURE_KEY, "Architecture", "ARCH from "
		+ TQ_ARCHITECTURE_ADI_KEY + " and " + TQ_ARCHITECTURE_COH_KEY, Metric.ValueType.PERCENT,
		Metric.DIRECTION_BETTER, true, DOMAIN_ARCHITECTURE);
